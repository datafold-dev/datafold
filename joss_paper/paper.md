...
Contrasting with an equation-driven workflow, data-driven models allow a wider range of systems that may also include unknown or untractable equations to be analyzed. The models can be used in a variety of data-driven usecases, such as amplifying the analysis of unknown systems or merely serve as an equation-free surrogate by providing fast and approximate responses for unseen data. 
