...
*datafold* is a Python package that provides **data**-driven models for scattered point clouds to find an *explicit* mani-**fold** parametrization and to identify non-linear dynamical systems. 

The explicit parametrization allows prior knowledge of a system and its problem-specific domain to be included, such as the (partially) known governing equation terms of a system [@williams4:2015; @brunton18:2016] or the proximity between points in the dataset [@coifman8:2006]. 
