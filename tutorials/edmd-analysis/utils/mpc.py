...
class MPC:
    def __init__(self, predictor: Predictor, config: MPCConfig,
    ...
    def predict(self, reference, initial_conds):
        ...
        mpc_control_a = self._mpc.generate_control_signal(ic_a, ref_a) \
                .reshape(-1)
        ...
        return MPCResult(initial_conds, t, reference, mpc_control, mpc_pred, mpc_cost, self.config)
