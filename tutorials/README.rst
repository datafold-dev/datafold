.. NOTE: this file was automatically generated with '/home/daniel/Code/datafold-dev/doc/source/generate_tutorials_page.py'. Navigate to this file, if you wish to change the content of this page.
...
* ``08_gh_oos.ipynb`` (`download <https://gitlab.com/datafold-dev/datafold/-/raw/master/tutorials/08_gh_oos.ipynb?inline=false>`__, `doc <https://datafold-dev.gitlab.io/datafold/tutorial_08_gh_oos.html>`__)
    We showcase the out-of-sample extension for manifold learning models such as the ``DiffusionMaps`` model. For this we use the ``GeometricHarmonicsInterpolator`` for out-of-sample and ``LaplacianPyramidsInterpolator`` for the pre-image mapping respectively.
* ``09_dmd_mixed_spatial_signals.ipynb`` (`download <https://gitlab.com/datafold-dev/datafold/-/raw/master/tutorials/09_dmd_mixed_spatial_signals.ipynb?inline=false>`__, `doc <https://datafold-dev.gitlab.io/datafold/tutorial_09_dmd_mixed_spatial_signals.html>`__)
    We utilize dynamic mode decomposition (DMD) on a linear spatiotemporal system. This system is formed by combining two mixed spatiotemporal signals. The example is from the DMD book by Kutz et al.

    **References**: `pykoopman tutorial <https://github.com/dynamicslab/pykoopman/blob/master/docs/tutorial_dmd_separating_two_mixed_signals_400d_system.ipynb>`__ :octicon:`link-external` |  :cite:t:`kutz-2016`
* ``10_edmd_limitcycle.ipynb`` (`download <https://gitlab.com/datafold-dev/datafold/-/raw/master/tutorials/10_edmd_limitcycle.ipynb?inline=false>`__, `doc <https://datafold-dev.gitlab.io/datafold/tutorial_10_edmd_limitcycle.html>`__)
...
* ``11_dmd_control.ipynb`` (`download <https://gitlab.com/datafold-dev/datafold/-/raw/master/tutorials/11_dmd_control.ipynb?inline=false>`__, `doc <https://datafold-dev.gitlab.io/datafold/tutorial_11_dmd_control.html>`__)
...
* ``12_edmd_control.ipynb`` (`download <https://gitlab.com/datafold-dev/datafold/-/raw/master/tutorials/12_edmd_control.ipynb?inline=false>`__, `doc <https://datafold-dev.gitlab.io/datafold/tutorial_12_edmd_control.html>`__)
...
* ``13_EDMD_with_dictionary_learning.ipynb`` (`download <https://gitlab.com/datafold-dev/datafold/-/raw/master/tutorials/13_EDMD_with_dictionary_learning.ipynb?inline=false>`__, `doc <https://datafold-dev.gitlab.io/datafold/tutorial_13_EDMD_with_dictionary_learning.html>`__)
...
* ``14_kmpc_flowcontrol.ipynb`` (`download <https://gitlab.com/datafold-dev/datafold/-/raw/master/tutorials/14_kmpc_flowcontrol.ipynb?inline=false>`__, `doc <https://datafold-dev.gitlab.io/datafold/tutorial_14_kmpc_flowcontrol.html>`__)
...
* ``15_kmpc_motor_engine.ipynb`` (`download <https://gitlab.com/datafold-dev/datafold/-/raw/master/tutorials/15_kmpc_motor_engine.ipynb?inline=false>`__, `doc <https://datafold-dev.gitlab.io/datafold/tutorial_15_kmpc_motor_engine.html>`__)
...
* ``16_online_dmd.ipynb`` (`download <https://gitlab.com/datafold-dev/datafold/-/raw/master/tutorials/16_online_dmd.ipynb?inline=false>`__, `doc <https://datafold-dev.gitlab.io/datafold/tutorial_16_online_dmd.html>`__)
